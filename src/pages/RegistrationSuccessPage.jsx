    ...
    <main className="mx-auto min-h-[min(100vh,880px)] w-full max-w-[1600px] bg-background-light pb-[max(104px,calc(96px+env(safe-area-inset-bottom)))] pt-4 md:pb-10 md:pt-5">
      <div className="page-gutter-x">
        <div className="premium-shell overflow-hidden">
          {/* Header — success */}
          <div className="border-b border-black/[0.06] bg-gradient-to-b from-success-green/[0.06] to-white px-4 py-8 text-center sm:px-6 md:py-10">
            <div className="mx-auto mb-5 flex size-16 items-center justify-center rounded-full border border-success-green/20 bg-success-green/[0.08] text-emerald-800 shadow-sm sm:size-20">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm font-medium text-primary">
              You chose this because you value: {topMotivation}.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 items-stretch gap-6 p-4 sm:p-6 lg:grid-cols-4 lg:gap-8 lg:p-8">
            <article className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded-2xl border border-success-green/15 bg-gradient-to-br from-success-green/[0.08] via-success-green/[0.03] to-white shadow-[0_8px_24px_rgba(15,15,16,0.06)] lg:col-span-2 lg:h-full">
            ...
            <aside className="flex min-h-0 min-w-0 flex-col gap-6 rounded-2xl border border-success-green/15 bg-gradient-to-br from-success-green/[0.08] via-success-green/[0.03] to-white p-6 sm:p-7 lg:col-span-2 lg:h-full">
